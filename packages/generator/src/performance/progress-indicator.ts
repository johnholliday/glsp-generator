...
export class GenerationProgress {
    ...
    constructor(
        ...
        if (this.phases.length === 0) {
            this.phases = [
                { name: 'Parsing', weight: 0.15, description: 'Parsing grammar file' },
                { name: 'Setup', weight: 0.1, description: 'Setting up project structure' },
                { name: 'Generation', weight: 0.5, description: 'Generating templates' },
                { name: 'Additional Features', weight: 0.15, description: 'Additional features generation' },
