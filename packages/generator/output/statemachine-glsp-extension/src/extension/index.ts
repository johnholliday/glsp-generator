...
export function activate(context: vscode.ExtensionContext): void {
    ...
    const openDiagramCommand = vscode.commands.registerCommand('statemachine.diagram.open', async (uri?: vscode.Uri) => {
    ...
    context.subscriptions.push(
        vscode.window.registerCustomEditorProvider('statemachine.diagram', provider, {
            webviewOptions: {
 ...
 */
class StatemachineDiagramProvider implements vscode.CustomTextEditorProvider {
